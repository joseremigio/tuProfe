                ...
                @foreach ($listaSelect['listPublicacion'] as $publicacion)
                    ...
                    <div class="col-sm-4">
                        <div class="team-member">
                            <img src="{{ asset('imgs/'.$publicacion->profesor->foto) }}" class="img-responsive img-circle" alt="">
                            <h4>{{$publicacion->profesor->nombres.', '.$publicacion->profesor->apellidos}}</h4>
                            

                            <p class="text-muted">{{$publicacion->profesor->gradoAcademico->nombre}}</p>
